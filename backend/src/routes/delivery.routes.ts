...
import { getDeliveries, getDelivery, createDelivery, updateDelivery, updateDeliveryStatus, toggleDeliveryPaid, deleteDelivery } from '../controllers/delivery.controller';
...
router.patch('/:id', authenticate, updateDelivery);
